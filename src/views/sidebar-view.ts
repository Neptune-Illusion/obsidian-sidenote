...
export class HighlightsSidebarView extends ItemView {
    ...
    constructor(leaf: WorkspaceLeaf, plugin: HighlightCommentsPlugin) {
        ...
        this.showNativeComments = this.plugin.app.loadLocalStorage('sidenote-show-native-comments') !== 'false';
        // Load follow-editor-scroll state from vault-specific localStorage
        this.followEditorScroll = this.plugin.app.loadLocalStorage('sidenote-follow-editor-scroll') === 'true';
    }
    ...
    private toggleNativeCommentsVisibility() {
        ...
        this.plugin.app.saveLocalStorage('sidenote-show-native-comments', this.showNativeComments.toString());
    }

    private toggleFollowEditorScroll() {
        this.followEditorScroll = !this.followEditorScroll;
        this.plugin.app.saveLocalStorage('sidenote-follow-editor-scroll', this.followEditorScroll.toString());
